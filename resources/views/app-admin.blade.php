...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    <!--begin::Logo-->
    <a href="#">
        <img alt="Logo" src="{{ asset('assets/media/logos/comp21logo.png') }}" style="width: 130px;"/>
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                @if (Auth::check())
                    <a href="#"
                       class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</a>
                @endif
                <div class="navi mt-2">
